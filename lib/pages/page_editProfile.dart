...
class _EditProfilePageState extends State<EditProfilePage> {
  ...
  void _saveProfile() {
    ...
    user.phoneNumber = _phoneController.text.trim().isEmpty
        ? null
                        ...
                        child: Form(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              TextFormField(
                                ...
                                validator: (v) {
                                  ...
                                  if (!pattern.hasMatch(cleaned))
                                    return 'Phone must be 8 digits and start with 8 or 9';
                                  return null;
                                },
                              ),
                              const SizedBox(height: 16),
                              ...
                              DropdownButtonFormField<String>(
                                initialValue:
                                    _locationOptions.contains(_location)
                                    ? _location
                                    : null,
